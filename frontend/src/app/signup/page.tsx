...
import { Loader2, AlertCircle, Mail, Lock, User as UserIcon, Zap } from 'lucide-react';
...
export default function SignupPage() {
    ...
    const handleSignup = async (e: React.FormEvent) => {
        ...
        try {
            ...
            useAuthStore.getState().setAuth({ id: 0, email, name, role: 'member', workspace_id: 0 }, access_token);
